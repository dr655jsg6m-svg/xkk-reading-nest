...
describe("CompanionDock", () => {
  ...
  it("supports jump, collapse, empty/error states, and clear recent", () => {
    ...
    expect(screen.getByRole("button", { name: "哥哥陪读" })).toBeInTheDocument();
    fireEvent.click(screen.getByRole("button", { name: "哥哥陪读" }));
    ...
    expect(screen.getByText("哥哥还没留下短评。")).toBeInTheDocument();
  ...
  it("lets the user manually save a pending companion draft", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "保存哥哥短评" }));
